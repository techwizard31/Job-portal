...
function Open() {
  ...
  return (
    <div className='w-full h-screen text-white bg-gradient-to-r from-[#2E073F] via-[#000B58] to-[#2E073F]'>
        <h1 className='font-oxanium text-9xl text-center pt-10 font-bold bg-clip-text text-transparent bg-gradient-to-t from-[#AA60C8] via-[#63688f] to-[#AA60C8]'>Jobify</h1>
